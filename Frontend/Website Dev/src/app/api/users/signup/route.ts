...
export async function POST(request: NextRequest) {
    try {
        ...
        const { 
            username, email, password, phone_number, kyc_document_type, 
            kyc_number, base_pincode, service_radius_km, total_fleet_size, 
            primary_equipment_type, upi_id 
        } = reqBody;
        ...
        const newUser = new User({
            ...
            total_fleet_size: Number(total_fleet_size),
